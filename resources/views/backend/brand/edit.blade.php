                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control {{$errors->has("brand_representatives_name") ? "is-invalid":""}}" id="brand_representatives_name"
                                                       name="brand_representatives_name" placeholder="Enter representatives name" value="{{old("brand_representatives_name", $brand->brand_representatives_name)}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control {{$errors->has("brand_email") ? "is-invalid":""}}"
                                                       id="brand_email" name="brand_email" placeholder="Enter email" value="{{old("brand_email", $brand->brand_email)}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control {{$errors->has("brand_mobile") ? "is-invalid":""}}" id="brand_mobile"
                                                       name="brand_mobile" placeholder="Enter mobile number" value="{{old("brand_mobile", $brand->brand_mobile)}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control {{$errors->has("address") ? "is-invalid":""}}" id="address" name="address"
                                                          placeholder="Enter address">{{old("address", $brand->address)}}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p>
                                                <label for="image" style="cursor: pointer;">
                                                    @if(!$brand->brand_thumbnail)
                                                        <img id="output" src="{{asset('/public/demo-pic/upload-image.jpg')}}" width="180"/>
                                                    @else
                                                        <img id="output" src="{{asset($brand->brand_thumbnail)}}" width="180"/>
                                                    @endif
                                                </label>
                                            </p>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p><label for="logo" style="cursor: pointer;">
                                                    ...
                                                    @else
                                                        <img id="outputLogo" src="{{asset($brand->brand_banner)}}" width="180"/>
                                                    @endif
                                                </label></p>
