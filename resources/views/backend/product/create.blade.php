                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="code" class="form-control {{$errors->has("code") ? "is-invalid":""}}"
                                                           id="code" value="{{old("code")}}" aria-describedby="code" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="product_price" value="{{old("alert_quantity")}}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="txt-editor form-control" name="product_details">{{old('product_details')}}</textarea>
                                            </div>
                                        </div>
