                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-none">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control {{$errors->has("designation") ? "is-invalid":""}}" id="designation" name="designation" placeholder="Enter Employee Designation" value="{{old("designation")}}">
                                                ...
                                                <select
                                                    ...
                                                    @foreach($warehouses as $warehouse)
                                                        @if(!empty(old('warehouse_id')))
                                                            <option {{ in_array($warehouse->id,old('warehouse_id')) ? 'selected' : ''}} value="{{$warehouse->id}}">{{ucwords($warehouse->name)}}</option>
                                                        @else
