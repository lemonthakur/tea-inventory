...
class ReceiveTransferReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $reportUrl = \App::make('url')->to('/').'/receive-transfer-report-excel?';
        ...
        if($user_ware_house){
            $transfers->whereIn('transfers.to_warehouse_id', $user_ware_house);
        }
        ...
        return view('backend.reports.receive-transfer-report', compact('transfers', 'warehouses', 'reportUrl'
            , 'total_transfer_qty', 'total_price', 'site_setting', 'site_unit', 'to_warehouses'));
    }

    public function receiveTransferReportExcel(Request $request)
    {
        ...
        $fileName = 'transfer-receive-report.csv';
        $headers = array(
